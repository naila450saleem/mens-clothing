...
import tag1 from "../assets/13_pic.jpg";
import tag2 from "../assets/48_pic.jpg";      
import tag3 from "../assets/51_pic.jpg";  
...
<div className="label-tags-container">
      ...
      {/* Title */}
      <h1 className="poly-title">PolyBags</h1>
